...
import {ICreateEntityPayload} from "@/services/CityService";
...
async function createEntity() {
  try {
    spinner.showSpinner()
    const response = await $api?.cities.create(entityPayload.value)
...
<template>
  ...
  >
    ...
    >
      <VRow>
        <VCol cols="12">
          <ProvincePicker :return-object="false" v-model="entityPayload.provinceId"></ProvincePicker>
        </VCol>
        <VCol cols="12">
          <VTextField
            v-model.trim="entityPayload.cityNameFa"
            variant="outlined"
            density="compact"
            label="نام فارسی شهر"
            color="success"
        ...
        <VCol cols="12">
          <VTextField
            v-model.trim="entityPayload.cityName"
            variant="outlined"
            density="compact"
        ...
        <VCol cols="12">
          <VTextField
            v-model.trim="entityPayload.cityCode"
            variant="outlined"
            density="compact"
            label="کد شهر "
            color="success"
