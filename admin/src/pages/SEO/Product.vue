...
async function getSeoData() {
  try {
    spinner.showSpinner()
    const response = await $api?.products.getAllProductForSeo(seoDataFilters.value)
...
async function updateSeoData() {
  try {
    spinner.showSpinner()
    const response = await $api?.products.updateProductSeo(tempSeoData.value)
