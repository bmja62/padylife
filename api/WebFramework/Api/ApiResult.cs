...
namespace WebFramework.Api
{
    public class ApiResult
    {
        ...
        public ApiResult<T> CastTo<T>() where T : class
        {
            return new ApiResult<T>(IsSuccess, StatusCode, default, Message);
        }
        public string CastLinkToString(string link)
        {
            return link;
        }
        #endregion
        ...
        where TData : class
    {
        ...
        public async Task<ApiResult<TData>> ExecuteOrReturn(Func<Task<ApiResult<TData>>> func)
        {
        ...
        public async Task<ApiResult<TData>> ExecuteOrReturn(Func<TData, Task<ApiResult<TData>>> func)
        {
            ArgumentNullException.ThrowIfNull(func, nameof(func));
            if (this.IsSuccess)
