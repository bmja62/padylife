...
async function updateUser() {
  ...
  try {
    ...
    if (authStore.getUser.age) {
      authStore.getUser.age = useUtils().convertNumbers2English(authStore.getUser.age)
    }
    if (authStore.getUser.wight) {
      authStore.getUser.wight = useUtils().convertNumbers2English(authStore.getUser.wight)
    }
    if (authStore.getUser.hight) {
      authStore.getUser.hight = useUtils().convertNumbers2English(authStore.getUser.hight)
    }
